...
class Toasts:
    ...
    async def showLaunched():
        await toast_async("Palm is running in the background", "Palm has started a session on this local network and ready to connect. Check out system tray for more options.")
